...
const float w_win = 800;
const float h_win = 600;
...
int main()
{
    ...
    {
        "C://Users//sparks//Pictures//skybox//right.jpg",
        "C://Users//sparks//Pictures//skybox//left.jpg",
        "C://Users//sparks//Pictures//skybox//top.jpg",
        "C://Users//sparks//Pictures//skybox//bottom.jpg",
        "C://Users//sparks//Pictures//skybox//front.jpg",
        "C://Users//sparks//Pictures//skybox//back.jpg",
    };
    ...
    int index = 0; 
    for (int y = -25* multiplier; y < 25 * multiplier; y += 1 * multiplier)
    {
        for (int x = -25 * multiplier; x < 25 * multiplier; x += 1 * multiplier)
        {
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        if (currentFrame - startTime >= 1.0)
        {
            ...
            std::cout << "\nFrames per second: " << numFrames << " ms";
            numFrames = 0;
            startTime = currentFrame;
        }

        view = glm::lookAt(pos, pos + front, up);
        projection = glm::perspective(glm::radians(fov), w_win / h_win, 0.1f, 2000.0f);
